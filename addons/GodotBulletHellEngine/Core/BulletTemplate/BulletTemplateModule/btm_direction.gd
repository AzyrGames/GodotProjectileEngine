...
# var _move_direction_change_type : BulletTemplate2D.MoveSpeedChangeType 
...
# var _move_direction_math_type : BulletTemplate2D.MoveSpeedChangeType 
# var _move_direction_math_loop : BulletTemplate2D.LoopType 
