...
@export_custom(PROPERTY_HINT_LINK, "") var texture_scale: Vector2 = Vector2.ONE
...
## Reverse Z index, make new bullet render underneath older bullet
...
@export var speed_projectile_behaviors: ProjectileBehaviorSpeed
